  ...
  return (
    <DropdownMenu>
      ...
      >
        ...
        <DropdownMenuItem
          onClick={handleProfileNavigate}
          className="flex items-center justify-center space-x-2 p-2 rounded-md hover:bg-gray-100 dark:hover:bg-gray-700 cursor-pointer"
        >
        ...
        <DropdownMenuItem
          ...
          className="flex items-center space-x-2 p-2 justify-center rounded-md hover:bg-gray-100 dark:hover:bg-gray-700 cursor-pointer"
        >
