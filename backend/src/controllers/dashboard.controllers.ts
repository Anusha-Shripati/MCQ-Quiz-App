...
export class DashboardController {
    ...
    interviewCount = async (req: Request, res: Response, next: NextFunction) => {
        try {
            ...
            return generateResponse(res, 200, questionData, true, "Interview count retrieved successfully");
        } catch (error) {
            next(error);
        }
    }
    ...
    interviewData = async (req: Request, res: Response, next: NextFunction) => {
        try {
            ...
            return generateResponse(res, 200, questionData, true, "Interview data retrieved successfully");
        } catch (error) {
            next(error);
        }
    }
    ...
    interviewScroreData = async (req: Request, res: Response, next: NextFunction) => {
        try {
            ...
            return generateResponse(res, 200, questionData, true, "Interview score data retrieved successfully");
        } catch (error) {
            next(error);
        }
    }
