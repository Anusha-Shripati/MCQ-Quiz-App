...
export default {
  ...
  safelist: [
    {
      pattern:
        /bg-(slate|green|gray|rose|fuchsia|purple|teal|stone)-(100|200|300|400|500|600|700|800)/,
    },
    {
      pattern:
        /text-(slate|green|gray|rose|fuchsia|purple|teal|stone)-(100|200|300|400|500|600|700|800)/,
    },
  ],
  theme: {
    extend: {
