  ...
  return (
    <Card className="max-h-[calc(50vh+10px)] overflow-y-auto dark:bg-gray-800 dark:border-gray-700">
      <CardHeader className="p-4">
        <CardTitle className="font-bold text-lg dark:text-white">
          Assessment Summary
        </CardTitle>
            ...
            <Table className="text-sm">
              <TableHeader>
                <TableRow className="bg-gray-50 dark:bg-gray-700">
                  <TableHead className="w-[30%] p-2 dark:text-white">
                    Technology
                  </TableHead>
                  ...
                  <TableHead className="text-center p-2 dark:text-white">
                    Total
                  </TableHead>
                </TableRow>
              </TableHeader>
              <TableBody>
                {formData.technologies.map((tech) => {
                  ...
                  return (
                    ...
                    >
                      <TableCell className="font-medium p-2 dark:text-white">
                        {tech.name}
                      </TableCell>
                ...
                <TableRow className="hover:bg-gray-50 dark:hover:bg-gray-600">
                  ...
                  <TableCell className="text-center p-2 dark:text-gray-300">
                    {formData.technologies.reduce(
                      (sum, tech) => sum + tech.easy,
                      0
                    )}
                  </TableCell>
                  <TableCell className="text-center p-2 dark:text-gray-300">
                    {formData.technologies.reduce(
                      (sum, tech) => sum + tech.medium,
                      0
                    )}
                  </TableCell>
                  <TableCell className="text-center p-2 dark:text-gray-300">
                    {formData.technologies.reduce(
                      (sum, tech) => sum + tech.hard,
                      0
                    )}
                  </TableCell>
                  <TableCell className="text-center p-2 font-semibold dark:text-white">
