        ...
        <div className="bg-white dark:bg-gray-800 border dark:border-gray-700 p-6 rounded-xl shadow-sm space-y-6 transition-all duration-300 ease-in-out animate-in fade-in zoom-in-95">
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
                ...
                <div className="bg-gray-50 dark:bg-gray-700 rounded-xl p-4 flex flex-col shadow-sm border border-gray-200 dark:border-gray-600">
                    <div className="text-sm font-medium text-gray-500 dark:text-gray-400 mb-1">Result Score</div>
                    ...
                    <div className="flex items-center space-x-2 mb-2">
                        ...
                        <span className={`px-2 py-1 text-xs font-medium rounded-full ${row?.is_passed
                    ...
                    >
                        ...
                        </svg> View Detailed Report
                    </Link>
                </div>

                {/* Test Time Card */}
                <div className="bg-gray-50 dark:bg-gray-700 rounded-xl p-4 flex flex-col shadow-sm border border-gray-200 dark:border-gray-600">
                    <div className="text-sm font-medium text-gray-500 dark:text-gray-400 mb-1">Test Duration</div>
                    <div className="flex items-center mb-2">
                        ...
                        <Tooltip>
                            ...
                            <TooltipContent className="bg-gray-800 text-white p-2 rounded shadow-lg">
                                ...
                                <p>{formatTestDateRange(row?.exam?.start_time as string, row?.exam?.end_time as string)}</p>
                            </TooltipContent>
                        </Tooltip>
                    </div>

                    <div className="text-sm font-medium text-gray-500 dark:text-gray-400 mt-2 mb-1">Test Date</div>
                ...
                {/* Created By Card */}
                <div className="bg-gray-50 dark:bg-gray-700 rounded-xl p-4 flex flex-col shadow-sm border border-gray-200 dark:border-gray-600">
                    <div className="text-sm font-medium text-gray-500 dark:text-gray-400 mb-1">Created By</div>
                    <div className="flex items-center mb-2">
                    ...
                    <div className="flex items-center">
                        ...
                        <span className="text-gray-700 dark:text-gray-300">
                            {row?.exam?.created_at ? dayjs(row?.exam?.created_at).format('DD/MM/YYYY h:mm A') : "-"}
                        </span>
                    </div>
                </div>
            </div>
            ...
            <div className="bg-gray-50 dark:bg-gray-700 rounded-xl p-5 shadow-sm border border-gray-200 dark:border-gray-600">
                ...
                <div className="overflow-hidden rounded-md border border-gray-200 dark:border-gray-600">
                    ...
                    <div className="grid grid-cols-12 items-center p-3 bg-white dark:bg-gray-800 border-b border-gray-200 dark:border-gray-700">
                        <div className="col-span-5 font-medium text-gray-800 dark:text-gray-200 pl-2">Overall</div>
                        ...
                        <div className="col-span-3">
                            <div className="flex items-center justify-center">
                                ...
                                <div className="w-16 bg-gray-200 dark:bg-gray-700 rounded-full h-1.5">
                                    <div
                                        className={`h-1.5 rounded-full ${row?.is_passed ? "bg-green-500" : "bg-red-500"
                                            }`}
                                        style={{ width: `${Math.min(row?.percentage || 0, 100)}%` }}
                                    />
                                </div>
                        ...
                        <div className="col-span-2 text-right pr-2">
                            <span className={`px-2 py-0.5 text-xs font-medium rounded-full ${row?.is_passed
                                ? "bg-green-100 text-green-800 dark:bg-green-900 dark:text-green-300"
                                : "bg-red-100 text-red-800 dark:bg-red-900 dark:text-red-300"
                                }`}>
                        ...
                        >
                            ...
                            <div className="col-span-3">
                                <div className="flex items-center justify-center">
                                    ...
                                    <div className="w-16 bg-gray-200 dark:bg-gray-700 rounded-full h-1.5">
                                        <div
                                            className={`h-1.5 rounded-full ${technology.percentage >= (row?.pass_criteria || 60) ? "bg-green-500" : "bg-red-500"
                                                }`}
                            ...
                            {/* <div className="col-span-2 text-right pr-2">
                                <span className={`px-2 py-0.5 text-xs font-medium rounded-full ${technology.percentage >= (row?.pass_criteria || 60)
                                    ? "bg-green-100 text-green-800 dark:bg-green-900 dark:text-green-300"
                                    : "bg-red-100 text-red-800 dark:bg-red-900 dark:text-red-300"
                                    }`}>
