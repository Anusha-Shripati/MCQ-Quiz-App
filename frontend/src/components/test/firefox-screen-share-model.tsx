  interface FirefoxScreenSharePromptProps {
    handleFirefoxScreenShare: () => void;
  }
  const FirefoxScreenSharePrompt = ({ handleFirefoxScreenShare }: FirefoxScreenSharePromptProps) => (
    <div className="fixed inset-0 bg-white flex items-center justify-center z-50 p-4 transition-all duration-300">
      <div className="w-full max-w-lg bg-white rounded-xl shadow-2xl overflow-hidden transition-transform duration-300 scale-100">
        <div className="p-6 bg-red-600 text-white">
          <h2 className="text-2xl font-bold">Screen Sharing Required</h2>
        </div>
        <div className="p-6">
          <div className="flex items-center mb-6 text-amber-600">
            ...
            <p className="font-semibold">This exam requires screen recording</p>
          </div>

          <p className="mb-4 text-gray-600">
            Please click the button below to share your screen. When prompted, select{' '}
            <strong>Entire Screen</strong> to ensure proper exam monitoring.
          </p>
...
export default FirefoxScreenSharePrompt;